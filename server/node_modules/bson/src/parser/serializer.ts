import { Binary, validateBinaryVector } from 'bson/src/binary';
import type { BSONSymbol, DBRef, Document, MaxKey } from 'bson/src/bson';
import type { Code } from 'bson/src/code';
import * as constants from 'bson/src/constants';
import type { DBRefLike } from 'bson/src/db_ref';
import type { Decimal128 } from 'bson/src/decimal128';
import type { Double } from 'bson/src/double';
import { BSONError, BSONVersionError } from 'bson/src/error';
import type { Int32 } from 'bson/src/int_32';
import { Long } from 'bson/src/long';
import type { MinKey } from 'bson/src/min_key';
import type { ObjectId } from 'bson/src/objectid';
import type { BSONRegExp } from 'bson/src/regexp';
import { ByteUtils } from 'bson/src/utils/byte_utils';
import { NumberUtils } from 'bson/src/utils/number_utils';
import { isAnyArrayBuffer, isDate, isMap, isRegExp, isUint8Array } from 'bson/src/parser/utils';

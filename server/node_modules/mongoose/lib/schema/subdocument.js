...
const SchemaSubdocumentOptions = require('mongoose/lib/options/schemaSubdocumentOptions');
...
const castToNumber = require('mongoose/lib/schema/operators/helpers').castToNumber;
const createJSONSchemaTypeDefinition = require('mongoose/lib/helpers/createJSONSchemaTypeDefinition');
const discriminator = require('mongoose/lib/helpers/model/discriminator');
const geospatial = require('mongoose/lib/schema/operators/geospatial');
const getConstructor = require('mongoose/lib/helpers/discriminator/getConstructor');
const handleIdOption = require('mongoose/lib/helpers/schema/handleIdOption');
...
const InvalidSchemaOptionError = require('mongoose/lib/error/invalidSchemaOption');
...
function _createConstructor(schema, baseClass, options) {
  // lazy load
  SubdocumentType || (SubdocumentType = require('mongoose/lib/types/subdocument'));

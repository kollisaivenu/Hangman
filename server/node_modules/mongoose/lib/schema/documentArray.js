...
const DocumentArrayElement = require('mongoose/lib/schema/documentArrayElement');
const EventEmitter = require('events').EventEmitter;
const SchemaArray = require('mongoose/lib/schema/array');
const SchemaDocumentArrayOptions =
  require('mongoose/lib/options/schemaDocumentArrayOptions');
...
function _createConstructor(schema, options, baseClass) {
  Subdocument || (Subdocument = require('mongoose/lib/types/arraySubdocument'));
...
SchemaDocumentArray.prototype.doValidate = function(array, fn, scope, options) {
  // lazy load
  MongooseDocumentArray || (MongooseDocumentArray = require('mongoose/lib/types/documentArray'));

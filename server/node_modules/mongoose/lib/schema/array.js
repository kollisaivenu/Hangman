...
const SchemaArrayOptions = require('mongoose/lib/options/schemaArrayOptions');
...
const arrayDepth = require('mongoose/lib/helpers/arrayDepth');
...
function SchemaArray(key, cast, options, schemaOptions) {
  // lazy load
  EmbeddedDoc || (EmbeddedDoc = require('mongoose/lib/types').Embedded);

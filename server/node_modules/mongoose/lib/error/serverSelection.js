...
const allServersUnknown = require('mongoose/lib/helpers/topology/allServersUnknown');
const isAtlas = require('mongoose/lib/helpers/topology/isAtlas');
const isSSLError = require('mongoose/lib/helpers/topology/isSSLError');

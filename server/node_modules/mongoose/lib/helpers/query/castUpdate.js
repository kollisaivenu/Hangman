...
const SchemaString = require('mongoose/lib/schema/string');
...
const getEmbeddedDiscriminatorPath = require('mongoose/lib/helpers/query/getEmbeddedDiscriminatorPath');
const handleImmutable = require('mongoose/lib/helpers/query/handleImmutable');
const moveImmutableProperties = require('mongoose/lib/helpers/update/moveImmutableProperties');
...
const { internalToObjectOptions } = require('mongoose/lib/options');

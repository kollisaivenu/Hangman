...
const applyBuiltinPlugins = require('mongoose/lib/helpers/schema/applyBuiltinPlugins');
...
const mergeDiscriminatorSchema = require('mongoose/lib/helpers/discriminator/mergeDiscriminatorSchema');

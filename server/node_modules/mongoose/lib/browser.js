...
require('mongoose/lib/driver').set(require('mongoose/lib/drivers/browser'));
...
exports.Error = require('mongoose/lib/error');
...
exports.Schema = require('mongoose/lib/schema');
 ...
 * @api public
 */
exports.Types = require('mongoose/lib/types');
 ...
 * @api public
 */
exports.VirtualType = require('mongoose/lib/virtualType');
...
exports.SchemaTypeOptions = require('mongoose/lib/options/schemaTypeOptions');

...
import { type BSONSerializeOptions, type Document, resolveBSONOptions } from 'mongodb/src/bson';
import { ChangeStream, type ChangeStreamDocument, type ChangeStreamOptions } from 'mongodb/src/change_stream';
import type { AutoEncrypter, AutoEncryptionOptions } from 'mongodb/src/client-side-encryption/auto_encrypter';
import {
  type AuthMechanismProperties,
  DEFAULT_ALLOWED_HOSTS,
  type MongoCredentials
} from 'mongodb/src/cmap/auth/mongo_credentials';
import { type TokenCache } from 'mongodb/src/cmap/auth/mongodb_oidc/token_cache';
import { AuthMechanism } from 'mongodb/src/cmap/auth/providers';
import type { LEGAL_TCP_SOCKET_OPTIONS, LEGAL_TLS_SOCKET_OPTIONS } from 'mongodb/src/cmap/connect';
import type { Connection } from 'mongodb/src/cmap/connection';
import type { ClientMetadata } from 'mongodb/src/cmap/handshake/client_metadata';
import type { CompressorName } from 'mongodb/src/cmap/wire_protocol/compression';
import { parseOptions, resolveSRVRecord } from 'mongodb/src/connection_string';
import { MONGO_CLIENT_EVENTS } from 'mongodb/src/constants';
import { type AbstractCursor } from 'mongodb/src/cursor/abstract_cursor';
import { Db, type DbOptions } from 'mongodb/src/db';
import type { Encrypter } from 'mongodb/src/encrypter';
import { MongoInvalidArgumentError } from 'mongodb/src/error';
import { MongoClientAuthProviders } from 'mongodb/src/mongo_client_auth_providers';
import {
...
import { TypedEventEmitter } from 'mongodb/src/mongo_types';
import {
  type ClientBulkWriteModel,
  type ClientBulkWriteOptions,
  type ClientBulkWriteResult
} from 'mongodb/src/operations/client_bulk_write/common';
import { ClientBulkWriteExecutor } from 'mongodb/src/operations/client_bulk_write/executor';
import { executeOperation } from 'mongodb/src/operations/execute_operation';
import { RunAdminCommandOperation } from 'mongodb/src/operations/run_command';
import type { ReadConcern, ReadConcernLevel, ReadConcernLike } from 'mongodb/src/read_concern';
import { ReadPreference, type ReadPreferenceMode } from 'mongodb/src/read_preference';
import { type AsyncDisposable, configureResourceManagement } from 'mongodb/src/resource_management';
import type { ServerMonitoringMode } from 'mongodb/src/sdam/monitor';
import type { TagSet } from 'mongodb/src/sdam/server_description';
import { readPreferenceServerSelector } from 'mongodb/src/sdam/server_selection';
import type { SrvPoller } from 'mongodb/src/sdam/srv_polling';
import { Topology, type TopologyEvents } from 'mongodb/src/sdam/topology';
import { ClientSession, type ClientSessionOptions, ServerSessionPool } from 'mongodb/src/sessions';
import {
  COSMOS_DB_CHECK,
  COSMOS_DB_MSG,
  DOCUMENT_DB_CHECK,
...
import type { W, WriteConcern, WriteConcernSettings } from 'mongodb/src/write_concern';
